...
// ali-v5: AliAISection is parked. Component lives at
// ./components/ali/AliAISection.tsx and its CSS is in globals.css under
// `.ali-ai`. Re-add by uncommenting the import and the <AliAISection />
// line below when you're ready to polish it.
// import AliAISection from './components/ali/AliAISection'
...
// ali-v4: new "Gap" section sits between the course teaser and the booking
// CTA. Two-hands scroll-triggered composition — needs a transparent PNG of
// a single hand at /public/adam-hand.png.
  ...
  return (
    <div className="ali-site site-shell">
      ...
      <main id="top">
        ...
        {/* ali-v5: <AliAISection /> parked here — re-add when ready. */}
        ...
        {/* ali-v4: scroll-driven "two hands reaching" section. Headline
            fades in, then both hands glide in from opposite edges and
            almost meet at centre as the user scrolls past. */}
        <AliCreationGap />
