...
// ali-v4: per-coin base color, kept in lockstep with CoinField.tsx so the
// bridge section's coins render in the same gold/silver/copper as the hero
// instead of falling back to the GLB's default silver. Index alignment
// matches COIN_LABELS above.
//   STRATEGY  → gold        #E5C547
//   AI        → silver      #DCDCDC
//   EXECUTION → rose-copper #C97B5D
const COIN_COLORS = ['#E5C547', '#DCDCDC', '#C97B5D']
