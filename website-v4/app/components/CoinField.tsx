...
// ali-v4: medal trio matched to the user's reference (silver / gold /
// rose-copper). Reordered so the semantic mapping is gold = top-tier
// thinking, silver = analytical clarity, copper = warm grounded delivery.
//   STRATEGY  → gold        #E5C547   (the standout, premier thinking)
//   AI        → silver      #DCDCDC   (clean, analytical)
//   EXECUTION → rose-copper #C97B5D   (warm, grounded delivery)
const coinColors = ['#E5C547', '#DCDCDC', '#C97B5D']

// Dark engraved labels on all three — high contrast on every metal:
//   gold        + near-black ≈ 10:1    ✓
//   silver      + near-black ≈ 12:1    ✓
//   rose-copper + near-black ≈ 4.2:1   ✓ (large display text)
const coinLabelColors = ['#202328', '#202328', '#202328']
